let touche_envoyer1 = document.getElementById('touche_envoyer1');
let touche_ajouter_etoile1 = document.getElementById('touche_ajouter_etoile1');
let touche_profil1 = document.getElementById('touche_profil1');

let touche_envoyer2 = document.getElementById('touche_envoyer2');
let touche_ajouter_etoile2 = document.getElementById('touche_ajouter_etoile2');
let touche_profil2 = document.getElementById('touche_profil2');

let voirEnvoyerMessage = document.getElementById('voirEnvoyerMessage');
let voirEnvoyerMessageRemplis = document.getElementById('voirEnvoyerMessageRemplis');
let voirMonProfil = document.getElementById('voirMonProfil');
let voirMesEtoiles = document.getElementById('voirMesEtoiles');

let titre_etoiles = document.getElementById('titre_etoiles');

let nav = document.getElementById('Nav');
let photo_profil = document.getElementById('photo_profil');
...
function envoisPour2(){
    ...
    // }
    let tailleMain_2 = document.getElementById('main_2').clientWidth;
    if(tailleMain_2 == 0){
        touche_profil1.style.width = "50px";
        touche_ajouter_etoile1.style.width = "50px";
        touche_envoyer1.style.width = "60px";
